...
namespace WrenchitSafe.Controllers
{
    [Authorize]
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    {
                        var musician = context.Mechanics.Where(u => u.ApplicationId == user.Id).FirstOrDefault();
                        if (musician == null)
                        {
                            return RedirectToAction("Create", "Mechanics");/* //If they never made profile after registration then they must go to "Create", "Musician"*/
                        }
                        return RedirectToAction("Index", "Home"); /*//Redirect to there profile "Index", "Musicians"*/
                    }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return RedirectToAction("WelcomeC", "Home"); //
                    }
                    else if (model.UserRoles.Equals("Mechanic"))
                    {
